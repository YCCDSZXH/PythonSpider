...
class DouYin(object):
    def __init__(self, width = 500, height = 300):
        ...
        self.driver = Browser(driver_name='chrome', executable_path='D:/python', options=chrome_options, headless=True)
    ...
    def get_video_urls(self, user_id):
        ...
        while unique_id != user_id:
            search_url = 'https://api.amemv.com/aweme/v1/discover/search/?cursor=0&keyword=%s&count=10&type=1&retry_type=no_retry&iid=17900846586&device_id=34692364855&ac=wifi&channel=xiaomi&aid=1128&app_name=aweme&version_code=162&version_name=1.6.2&device_platform=android&ssmix=a&device_type=MI5&device_brand=Xiaomi&os_api=24&os_version=7.0&uuid=861945034132187&openudid=dc451556fc0eeadb&manifest_version_code=162&resolution=1080*1920&dpi=480&update_version_code=1622' % user_id
    ...
    def get_download_url(self, video_url):
        ...
        video_url_js = re.findall('var MNIST_data = \[(.+)\];', str(script))[0]
